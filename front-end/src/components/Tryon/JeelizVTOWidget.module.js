...
var $jscomp$lookupPolyfilledValue = function (ja, na) {
  var sa = $jscomp.propertyToPolyfillSymbol[na];
  if (null == sa) return ja[na];
  sa = ja[sa];
  return void 0 !== sa ? sa : ja[na];
};
$jscomp.polyfill = function (ja, na, sa, Pa) {
  na &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(ja, na, sa, Pa)
      : $jscomp.polyfillUnisolated(ja, na, sa, Pa));
};
$jscomp.polyfillUnisolated = function (ja, na, sa, Pa) {
  sa = $jscomp.global;
  ja = ja.split(".");
  for (Pa = 0; Pa < ja.length - 1; Pa++) {
    var wa = ja[Pa];
    if (!(wa in sa)) return;
    sa = sa[wa];
  }
  ...
  na != Pa &&
    null != na &&
    $jscomp.defineProperty(sa, ja, {
      configurable: !0,
      writable: !0,
      value: na,
    });
};
$jscomp.polyfillIsolated = function (ja, na, sa, Pa) {
  var wa = ja.split(".");
  ja = 1 === wa.length;
  Pa = wa[0];
  Pa = !ja && Pa in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
  for (var qb = 0; qb < wa.length - 1; qb++) {
    var va = wa[qb];
    if (!(va in Pa)) return;
    Pa = Pa[va];
  }
  wa = wa[wa.length - 1];
  sa = $jscomp.IS_SYMBOL_NATIVE && "es6" === sa ? Pa[wa] : null;
  na = na(sa);
  null != na &&
    (ja
      ? $jscomp.defineProperty($jscomp.polyfills, wa, {
          configurable: !0,
          writable: !0,
          value: na,
        })
      : na !== sa &&
        (($jscomp.propertyToPolyfillSymbol[wa] = $jscomp.IS_SYMBOL_NATIVE
          ? $jscomp.global.Symbol(wa)
          : $jscomp.POLYFILL_PREFIX + wa),
        (wa = $jscomp.propertyToPolyfillSymbol[wa]),
        $jscomp.defineProperty(Pa, wa, {
          configurable: !0,
          writable: !0,
          value: na,
        })));
...
$jscomp.assign =
  $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
    ? Object.assign
    : function (ja, na) {
        for (var sa = 1; sa < arguments.length; sa++) {
          var Pa = arguments[sa];
          if (Pa) for (var wa in Pa) $jscomp.owns(Pa, wa) && (ja[wa] = Pa[wa]);
        }
        return ja;
      };
$jscomp.polyfill(
...
$jscomp.polyfill(
  ...
  function (ja) {
    ...
    function sa(va) {
      return va instanceof wa
        ? va
        : new wa(function (Ja, Ua) {
            Ja(va);
          });
    }
    ...
    var Pa = $jscomp.global.setTimeout;
    ...
    wa.prototype.createResolveAndReject_ = function () {
      function va(eb) {
        return function (sb) {
          Ua || ((Ua = !0), eb.call(Ja, sb));
        };
      }
      var Ja = this,
        Ua = !1;
    ...
    wa.prototype.resolveTo_ = function (va) {
      if (va === this)
        this.reject_(new TypeError("A Promise cannot resolve to itself"));
      else if (va instanceof wa) this.settleSameAsPromise_(va);
      else {
        a: switch (typeof va) {
          case "object":
            var Ja = null != va;
    ...
    wa.prototype.resolveToNonPromiseObj_ = function (va) {
      var Ja = void 0;
      try {
        Ja = va.then;
      } catch (Ua) {
    ...
    wa.prototype.reject_ = function (va) {
      this.settle_(2, va);
    };
    wa.prototype.fulfill_ = function (va) {
      this.settle_(1, va);
    };
    wa.prototype.settle_ = function (va, Ja) {
      if (0 != this.state_)
        throw Error(
          "Cannot settle(" +
            va +
    ...
    wa.prototype.executeOnSettledCallbacks_ = function () {
      if (null != this.onSettledCallbacks_) {
        for (var va = 0; va < this.onSettledCallbacks_.length; ++va)
          qb.asyncExecute(this.onSettledCallbacks_[va]);
        this.onSettledCallbacks_ = null;
      }
    };
    var qb = new na();
    wa.prototype.settleSameAsPromise_ = function (va) {
      var Ja = this.createResolveAndReject_();
      va.callWhenSettled_(Ja.resolve, Ja.reject);
    };
    wa.prototype.settleSameAsThenable_ = function (va, Ja) {
      var Ua = this.createResolveAndReject_();
      try {
        va.call(Ja, Ua.resolve, Ua.reject);
      } catch (eb) {
        Ua.reject(eb);
      }
    };
    wa.prototype.then = function (va, Ja) {
      function Ua(yb, Fb) {
        return "function" == typeof yb
          ? function (ic) {
              try {
                eb(yb(ic));
              } catch (Zb) {
      ...
      var eb,
        sb,
        Sb = new wa(function (yb, Fb) {
          eb = yb;
          sb = Fb;
        });
      this.callWhenSettled_(Ua(va, eb), Ua(Ja, sb));
      return Sb;
    };
    wa.prototype.catch = function (va) {
      return this.then(void 0, va);
    };
    wa.prototype.callWhenSettled_ = function (va, Ja) {
      function Ua() {
        switch (eb.state_) {
          case 1:
            va(eb.result_);
          ...
          case 2:
            ...
            break;
          default:
            throw Error("Unexpected state: " + eb.state_);
        }
      }
      var eb = this;
      null == this.onSettledCallbacks_
        ? qb.asyncExecute(Ua)
        : this.onSettledCallbacks_.push(Ua);
    };
    wa.resolve = sa;
    wa.reject = function (va) {
      return new wa(function (Ja, Ua) {
        Ua(va);
      });
    };
    wa.race = function (va) {
      return new wa(function (Ja, Ua) {
        for (
          var eb = $jscomp.makeIterator(va), sb = eb.next();
          !sb.done;
          sb = eb.next()
        )
          sa(sb.value).callWhenSettled_(Ja, Ua);
      });
    };
    wa.all = function (va) {
      ...
      return Ua.done
        ...
        : new wa(function (eb, sb) {
            ...
            do
              yb.push(void 0),
                Fb++,
                sa(Ua.value).callWhenSettled_(Sb(yb.length - 1), sb),
                (Ua = Ja.next());
            while (!Ua.done);
          });
    };
...
$jscomp.findInternal = function (ja, na, sa) {
  ja instanceof String && (ja = String(ja));
  for (var Pa = ja.length, wa = 0; wa < Pa; wa++) {
    var qb = ja[wa];
    if (na.call(sa, qb, wa, ja)) return { i: wa, v: qb };
  }
  return { i: -1, v: void 0 };
};
$jscomp.polyfill(
  ...
  function (ja) {
    return ja
      ? ja
      : function (na, sa) {
          return $jscomp.findInternal(this, na, sa).v;
        };
  },
  "es6",
  "es3"
  ...
  function (ja) {
    return ja
      ...
      : function (na, sa) {
          ...
          var wa = Pa.length;
          sa = sa || 0;
          for (0 > sa && (sa = Math.max(sa + wa, 0)); sa < wa; sa++) {
            var qb = Pa[sa];
            if (qb === na || Object.is(qb, na)) return !0;
          }
          return !1;
        };
  },
...
$jscomp.checkStringArgs = function (ja, na, sa) {
  if (null == ja)
    throw new TypeError(
  ...
  function (ja) {
    return ja
      ...
      : function (na, sa) {
          return (
            -1 !==
            $jscomp.checkStringArgs(this, na, "includes").indexOf(na, sa || 0)
          );
        };
  },
  "es6",
...
$jscomp.polyfill(
  ...
  function (ja) {
    return ja
      ? ja
      : function (na, sa) {
          return $jscomp.findInternal(this, na, sa).i;
        };
  },
  "es6",
  "es3"
...
var JeelizVTOWidget = (function () {
  function ja() {
    Sa.mode = ob.realtime;
    Sa.isRT = !0;
    Ca.adjust = document.getElementById("JeelizVTOWidgetAdjust");
    if (Ca.adjust) {
      Ca.adjustNotice = document.getElementById("JeelizVTOWidgetAdjustNotice");
      Ca.adjustExit = document.getElementById("JeelizVTOWidgetAdjustExit");
  ...
  function Sb(S) {
    ...
    if (!S && 1 >= ua && 1 >= Ga && 1 === fb.oFactor)
      ...
      if (Sa.mode === ob.notLoaded) Wa.set_size(fb.cvWidth, fb.cvHeight, !1);
      else
        Wa.onLoad(function () {
    ...
    return S
      ? "json" === S.split(".").pop().toLowerCase()
        ...
        : va(Kb.glassesDBURL + S).then(function (V) {
            return V.intrinsic ? Zc(V.intrinsic) : "";
          })
      : Promise.resolve("");
  }
  var Lb = (function () {
      ...
      function Mb(a) {
        ...
        for (
          ...
          for (var I = p.length, u = 0, y = m; y < m + I; ++y)
            (p[u] = La(b, y)), ++u;
          for (I = m = 0; I < d; ++I) m += p[I] * Math.pow(2, -I - 1);
          l[h] =
            0 === m && 0 === x
              ? 0
              : q * (1 + m) * Math.pow(2, 1 + x - Math.pow(2, a - 1));
        }
        return l;
      }
      function lc(a) {
      ...
      function Gd() {
        ...
        function w(K, R) {
          ...
          for (pa in R) {
            var Oa = R[pa],
              pb = -1;
            pb = "number" === typeof pa ? pa : Z.indexOf(pa.toLowerCase());
            -1 !== pb && (K[pb] = Oa);
          }
          return K;
        }
        ...
        function x() {
          ...
          da.switch_viewer3D = function (K, R) {
            ...
            if (xa === ra.va)
              return ub !== ra.Ka || K
                ? ub === ra.Y && K
                  ? ((ub = ra.Ka), Ba.ra(Da.Hb), Ba.cb(1), R && R(), !0)
                  : !1
                : ((ub = ra.Y), Ba.ra(Da.Ja), Ba.cb(0), R && R(), !0);
            var Z = 0,
              pa = -1,
              Oa = 0;
            xa === ra.Y
          ...
          da.process_image = function (K) {
            ...
            if (J.Lc) throw Error("This feature cannot be called");
            var Qb = cb.FOVforced;
            ib.FOVHztDeg && (cb.FOVforced = ib.FOVHztDeg);
            Ba.ra(Da.Ja);
            return new Promise(function (Bb, rb) {
              return pa()
                .then(Oa)
              ...
              return Va
                ...
                : new Promise(function (Z, pa) {
                    ...
                    Promise.all([Ra.m(), Ra.zm()])
                      ...
                      .catch(function (Oa) {
                        Rb && Rb("GL_INCOMPATIBLE", "Cannot init JEELIZVTO");
                        pa(Oa);
                      });
                  });
            },
      ...
      start: function (S) {
        ...
        return new Promise(function (ua, Ga) {
          if (Sa.mode !== ob.notLoaded)
            ...
            Ca.loading = document.getElementById("JeelizVTOWidgetLoading");
            Hc.error = V.onError;
            jc = V.callbackReady;
            ic();
            Ka = qb(Ca.container);
